...
def Xuat_Kho(df):
    ...
    df['BioStats'] = df['BioStats'].astype(int)
    ...
    with st.form("my_form"):
        ...
        'Admin', 'Account', 'CTU', 'EI', 'IT', 'Estate','MolEPI','BioStats', 'Modelling', 'PE', 'Malaria', 'CNS', 'Dengue', 'TB', 'Lab',
        'MicroLab', 'Zoonoses', 'VA-ward'))
...
def Thong_Ke(df):
    ...
    if tk == 'Inventory Summary':
        ...
        data = df[['Admin', 'Account', 'CTU', 'EI', 'IT','Estate','MolEPI','BioStats', 'Modelling', 'PE', 'Malaria', 'CNS', 'Dengue', 'TB', 'Lab',
                   'MicroLab', 'Zoonoses', 'VA-ward']]
        st.bar_chart(data)
